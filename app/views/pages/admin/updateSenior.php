...
<header class="shadow-sm bg-body position-sticky top-0 w-100">
    ...
    <div class="card shadow-sm p-3 mb-5 bg-body rounded w-50">
        <div class="card-body ">
        <form action="<?php echo URLROOT ?>/SeniorController/updateSeniorById/<?php echo $data[1]["senior"]->id ?>" method="POST">
        <div class="mb-3 w-100">
                    <label for="exampleInputEmail1" class="form-label">email</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" value="<?php echo $data[1]["senior"]->email ?>"  name="email">          
                </div>
        <div class=" d-flex gap-3">
                <div class="mb-3 w-100">
                    <label for="exampleInputEmail1" class="form-label">nom</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $data[1]["senior"]->nom ?>"  name="nom">          
                </div>
                <div class="mb-3 w-100">
                    <label for="exampleInputEmail1" class="form-label">prenom</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $data[1]["senior"]->prenom ?>"  name="prenom">                      
                </div>
            </div>
            <div class=" d-flex gap-3">
            <div class="mb-3 w-100">
                    <label for="exampleInputEmail1" class="form-label">Equipe</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $data[1]["senior"]->Equipe ?>" name="Equipe">          
                </div>
                <div class="mb-3 w-100">
                    <label for="exampleInputEmail1" class="form-label">Matricule</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $data[1]["senior"]->Matricule ?>" name="Matricule">                 
                </div>
            </div>
            ...
            <div class=" d-flex gap-3">
                <div class="mb-3 w-100">
                    ...
                    <input type="password" class="form-control" id="exampleInputEmail1" value="<?php echo $data[1]["senior"]->password ?>" name="password">                 
                </div>
